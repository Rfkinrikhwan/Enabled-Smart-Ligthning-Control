...
const int soundThreshold = 100;            // Mungkin perlu disesuaikan dengan sensitivitas sensor
...
unsigned long wifiConnectTimeout = 30000; // 15 second timeout for WiFi connections
